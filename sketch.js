...
function preload() {
  ...
  playerImg = loadImage("assets/images/bird.png");
  enemyImg = loadImage("assets/images/enemy.png");
  bossImg = loadImage("assets/images/bigboss.png");

  // AUDIO
  bgMusic = loadSound("assets/sounds/bgmusic.mp3");
  shootSound = loadSound("assets/sounds/shoot.mp3");
  hitSound = loadSound("assets/sounds/gethit.mp3");
}
...
function drawBoss() {
  ...
  push();
  imageMode(CENTER);
  image(bossImg, boss.x, boss.y, boss.r * 2, boss.r * 2);
  pop();
}
...
function drawEnemies() {
  ...
  for (let i = 0; i < enemies.length; i++) {
    let e = enemies[i];
    image(enemyImg, e.x, e.y, e.r * 2, e.r * 2);
  }
